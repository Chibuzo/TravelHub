...
if (isset($_POST['add_park'])) {
    $user_model = new User();
    $user_model->createParkAdmin($_POST['full_name'], $_POST['username'], $_POST['password'], $travel_id, $_POST['park']);
}
if (isset($_POST['park_map'])) {
    $travel_park_map->addTravelParkMap($_POST['origin'], $_POST['destination_park'], $travel_id);
}
			...
			<div class="col-md-6 col-xs-12">
				<div class="box box-danger">
					...
					<div class="box-body">
						...
						<div id="detail-div">
                            <?php
                            $travel_park_maps = $travel_park_map->getTravelStateParkMaps($travel_id, $state_id);
...
<?php
$parks = "";
foreach ($db->query("SELECT * FROM parks WHERE state_id = '$state_id' ORDER BY park") AS $st) {
