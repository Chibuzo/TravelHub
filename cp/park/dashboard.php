...
$bookings = $booking->getByTravelPark($_SESSION['travel_id'], $_SESSION['park_id']);

// data for chart
$report_model = new Report();
$reports = $report_model->parkGetBooking($_SESSION['travel_id'], $_SESSION['park_id'], "MONTH", date('Y-01-01'), date('Y-m-d'));
